      ...
      <div class="row">
        ...
        <div class="<?php echo $class; ?>">
          ...
          <ul class="list-unstyled">
            ...
            <li>手環內圍直徑: <?php echo $braceletDiameter; ?> cm</li>
            <?php } ?>
            <?php if ($earingType) { ?>
          ...
          <input type="text" id="braceletDiameter" name="braceletDiameter" class="hidden" value="<?php echo  $braceletDiameter; ?>">
