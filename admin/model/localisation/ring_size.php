<?php
class ModelLocalisationRingSize extends Model {
...
//		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "ring_size WHERE ring_size_id = '" . (int)$ring_size_id . "' AND language_id = '" . (int)$this->config->get('config_language_id') . "'");
//
//		return $query->row;
//	}
