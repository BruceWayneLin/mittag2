        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-bracelet">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-status">手環內圍直徑:</label>
                <div class="col-sm-10">
                  <select class="form-control" name="braceletDiameter" id="">
                    <option value="" <?php echo $braceletDiameter == ' ' ? 'selected' :  ' ' ;?> >選擇長度</option>
                    <option value="6.5" <?php echo $braceletDiameter == 6.5 ? 'selected' :  ' ' ;?> >6.5cm</option>
                    <option value="7.5" <?php echo $braceletDiameter == 7.5 ? 'selected' :  ' ' ;?> >7.5cm</option>
                  </select>
                </div>
              </div>
            </div>
